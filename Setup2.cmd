...
powershell -noprofile -executionpolicy bypass -command "Disable-NetAdapterQos -Name '*' -ea 0"
...
netsh int tcp set global initialrto=500
...
start /b /w C:\Tools\MinSudo.exe -NoL -TI -P cmd.exe /c "C:\TEMP\Setup3.cmd"
